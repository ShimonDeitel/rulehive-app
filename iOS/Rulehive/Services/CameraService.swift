...
/// Thin AVFoundation capture-session wrapper: permission handling and still capture
/// for photographing rulebook pages, one at a time. UI-agnostic; the owning view
...
final class CameraService {
    ...
    enum CameraError: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .permissionDenied: return "Camera access was denied. Enable it in Settings to photograph rulebook pages."
    ...
    private let sessionQueue = DispatchQueue(label: "com.shimondeitel.rulehive.camera.session")
...
/// Bare `AVCaptureVideoPreviewLayer` host.
